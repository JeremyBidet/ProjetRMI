...
public class BankServiceLocator extends org.apache.axis.client.Service implements DefaultNamespace.BankService {
    ...
    public DefaultNamespace.Bank getBank() throws javax.xml.rpc.ServiceException {
    ...
    public DefaultNamespace.Bank getBank(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            DefaultNamespace.BankSoapBindingStub _stub = new DefaultNamespace.BankSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (DefaultNamespace.Bank.class.isAssignableFrom(serviceEndpointInterface)) {
                DefaultNamespace.BankSoapBindingStub _stub = new DefaultNamespace.BankSoapBindingStub(new java.net.URL(Bank_address), this);
                _stub.setPortName(getBankWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://DefaultNamespace", "BankService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://DefaultNamespace", "Bank"));
        }
