...
import DefaultNamespace.Bank;
import DefaultNamespace.BankServiceLocator;
import DefaultNamespace.BankSoapBindingStub;
...
public class _MainWSClient extends Application {
	...
	private static void startTests(boolean ignit) throws RemoteException, AuthenticationException, ParkException {
		if(!ignit) {
			return;
		}
		...
		// TODO: add tests for new IPark method: getRentedVehicles
